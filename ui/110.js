...
const page_custom = new function() {
    ...
    this.init = () => {
        ...
        elements.mode = _id("custom_game_setting_mode");
        ...
        Lobby.add_start_error_listener((data => {
            queue_dialog_msg({
                ...
                msg: localize(data.msg) + " " + data.blocking_users.join(", ")
            })
        }));
    ...
    this.init_modes = () => {
        ...
        create_game_mode_select(elements.mode, ((opt, field) => {
            this.user_update("mode", opt.dataset.value)
        }))
    };
    this.leave_action = () => {
        if (global_menu_page === "custom") {
