...
const page_game_report = new function() {
    ...
    function create_game_report(on_match_finish) {
        ...
        if (max_team_size > 12) {
            ...
            let current_page = 1;
            let show_loadout = false;
            let show_healing = true;
            let show_pickups = false;
            let pages = {
                1: [],
                2: []
            };
            ...
            for (let t of teams) {
                ...
                if (!ffa_mode || !head_rendered) {
                    ...
                    if (show_loadout) {
                        ...
                        head.appendChild(double);
                        if ("loadout" in page_idx) pages[page_idx["loadout"]].push(double)
                    }
                    if (show_loadout) {
                        ...
                        head.appendChild(double);
                        if ("damage" in page_idx) pages[page_idx["damage"]].push(double)
                    }
                    if (show_healing) {
                        ...
                        head.appendChild(double);
                        if ("healing" in page_idx) pages[page_idx["healing"]].push(double)
                    }
                    if (show_healing) {
                    ...
                    if (show_pickups) {
                        ...
                        head.appendChild(double);
                        if ("pickups" in page_idx) pages[page_idx["pickups"]].push(double)
                    }
                    if (show_pickups) {
                ...
                if ("players" in t && t.players.length) {
                    for (let p of t.players) {
                        ...
                        if (show_loadout) {
                            ...
                            if ("loadout" in page_idx) pages[page_idx["loadout"]].push(el)
                        }
                        if (show_loadout) {
                            ...
                            player.appendChild(el);
                            if ("damage" in page_idx) pages[page_idx["damage"]].push(el)
                        } {
                        ...
                        if (show_healing) {
                            ...
                            player.appendChild(el);
                            if ("healing" in page_idx) pages[page_idx["healing"]].push(el)
                        }
                        if (show_healing) {
                        ...
                        if (show_pickups) {
                            ...
                            player.appendChild(el);
                            if ("pickups" in page_idx) pages[page_idx["pickups"]].push(el)
                        }
                        if (show_pickups) {
    ...
    this.report_user = () => {
        ...
        select_user.dataset.theme = "modern";
        ...
        select_reason.dataset.theme = "modern";
